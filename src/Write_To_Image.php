...
class Write_To_Image
{
    ...
    */
    function convert_to_RGB($hex_string)
    {
        ...
        $hexStr = preg_replace("/[^0-9A-Fa-f]/", '', $hex_string); 
        $rgbArray = array();
        ...
        // returns the rgb string or the associative
        return array($rgbArray['red'], $rgbArray['green'], $rgbArray['blue']); 
        //return $returnAsString ? implode($seperator, $rgbArray) : $rgbArray; // returns the rgb string or the associative
    }
